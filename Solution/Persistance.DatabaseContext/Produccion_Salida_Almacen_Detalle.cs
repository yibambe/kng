namespace Persistance.DatabaseContext
{
    ...
    public partial class Produccion_Salida_Almacen_Detalle
    {
        [Key]
        [Column(Order = 0)]
        ...
        public virtual Produccion_Salida_Almacen Produccion_Salida_Almacen { get; set; }
    }
}
