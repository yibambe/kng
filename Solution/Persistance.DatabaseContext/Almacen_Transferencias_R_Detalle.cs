namespace Persistance.DatabaseContext
{
    ...
    public partial class Almacen_Transferencias_R_Detalle
    {
        [Key]
        [Column(Order = 0)]
        ...
        [Column(Order = 3)]
        [DatabaseGenerated(DatabaseGeneratedOption.None)]
        public int Clas_Producto_R { get; set; }

        [Key]
        [Column(Order = 4)]
        [DatabaseGenerated(DatabaseGeneratedOption.None)]
        public int Clas_Concepto_R { get; set; }

        public decimal Cantidad_R { get; set; }

        public int Familia_R { get; set; }

        public int Numero_Partida_R { get; set; }
    }
}
